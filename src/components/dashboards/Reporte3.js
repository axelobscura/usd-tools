    ...
    return (
        <>
            ...
            <Container fluid={true}>
                ...
                <Row>
                    <Col>
                        <h4><span className="lnr lnr-chevron-right"></span> Registros de operaciones relevantes en dolares no reportados en operaciones de dolares en efectivo por trimestre</h4>
                        <hr />
                        <Pay />
                    </Col>
                    <Col>
                ...
                <Row className="mt-3">
                    <Col>
                        <hr />
                        <h4><span class="lnr lnr-chevron-right"></span> Número de Registros de Operaciones relevantes en dolares no reportados en el reporte de operaciones relevantes por dia</h4>
                        <hr />
