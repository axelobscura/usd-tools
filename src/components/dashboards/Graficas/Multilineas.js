...
class Multilineas extends Component {
    componentDidMount() {
        var chart = am4core.create("chartdivMultilineas", am4charts.XYChart);
...
function processOut(hoveredSeries) {
  chart.series.each(function(series) {
    ...
    render() {
        return (
            <div id="chartdivMultilineas" style={{ width: "100%", height: "350px" }}></div>
        );
    }
}

export default Multilineas;