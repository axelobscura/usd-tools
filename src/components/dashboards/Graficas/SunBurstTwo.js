...
class SunBurstTwo extends Component {
    componentDidMount() {
        var chart = am4core.create("chartdivSunburstTwo", am4plugins.Sunburst);
    ...
    render() {
        return (
            <div id="chartdivSunburstTwo" style={{ width: "100%", height: "350px" }}></div>
        );
    }
}

export default SunBurstTwo;