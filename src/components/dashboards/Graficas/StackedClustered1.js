...
class StackedClustered1 extends Component {
    componentDidMount() {
        var chart = am4core.create("chartdivStackedClustered1", am4charts.XYChart);
// Add data
chart.data = [ {
    "year": "2003",
    "europe": 2.5,
  ...
  chart.legend = new am4charts.Legend();
    ...
    render() {
        return (
            <div id="chartdivStackedClustered1" style={{ width: "100%", height: "350px" }}></div>
        );
    }
}

export default StackedClustered1;